  ...
  return (
    <>
      ...
      <OL>
        ...
        <li><b>Sign, persist, then broadcast.</b> The transaction is signed locally, written to the database with its hash and nonce, committed, and only then sent. <Cite file="apps/worker/src/charger.js" line={133} /></li>
