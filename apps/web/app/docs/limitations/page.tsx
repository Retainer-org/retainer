  ...
  return (
    <>
      ...
      <Table head={["Limitation", "Detail", "Status"]} rows={[
        ...
        ["MetaMask upgrades accounts to 7702 by itself", <>In the first live session MetaMask converted both customer accounts to EIP-7702 accounts as part of revoking <Cite tx="0x2b19810bc90818b1a1baf0f6690aed03b1c3138cc0e218961b6f9d2b409b7a55" />. Their existing permissions keep working and stay revocable from the page, but a new registration from an upgraded account is refused. MetaMask&apos;s delegator has been tested and accepts the signature; whether to accept it is undecided.</>, "Decision pending"],
