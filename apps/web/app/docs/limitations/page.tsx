  ...
  return (
    <>
      ...
      <Table head={["Limitation", "Detail", "Status"]} rows={[
        ...
        ["An account upgraded to an unverified delegate cannot sign in", "Sign-in applies the same owner rules as registration. A customer whose account was upgraded to any EIP-7702 delegate other than the one verified can no longer sign in, so cannot see or revoke permissions from the permissions page. The permission itself can still be revoked on-chain, and by the merchant.", "Consequence of a deliberate rule"],
