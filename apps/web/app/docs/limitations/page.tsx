  ...
  return (
    <>
      ...
      <Table head={["Limitation", "Detail", "Status"]} rows={[
        ...
        ["No auth on the dashboard", "/dashboard is public and read-only. Acceptable for testnet data whose addresses are already public; not acceptable for a real merchant's data.", "Not built"],
